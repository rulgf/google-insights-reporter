...
export default class Semaforos extends  React.Component{
    ...
    //Funcion para cargar las Semaforo de la cuenta seleccionada
    cargarSemaforos(){
        $.ajax({
            type: 'GET',
            url: 'semaforos/'+this.state.selectedCuentaLbl,
            context: this,
            dataType: 'json',
            cache: false,
            success: function (data) {
                ...
                this.setState({semaforos: semaforos},function () {
    ...
    //Funcion para Crear, Modificar, o Eliminar un Semaforo
    createUpdateSemaforos(){
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                this.cargarSemaforos(this.state.selectedCuentaLbl);
            }.bind(this),
            error: function (xhr, status, err) {
                //Error
                console.error(this.props.url, status, err.toString());
    ...
    //Metodo para cargar los datos de un Semaforo en especifico
    loadSemaforo(id){
        $.ajax({
            type: 'GET',
            url: 'semaforo/'+id,
        ...
        if(this.state.action== 'POST'){
            ...
            acciones = [
                ...
                <FlatButton
                    ...
                    onTouchTap={this.createUpdateSemaforos.bind(this)}
                />
            ];
        } else if(this.state.action== 'PUT'){
            titulo='Modificar Semaforo';
            ...
            titulo='Eliminar Semaforo';
            exito= 'El registro fue eliminado exitosamente';
            contenido=[
                <div>
                    <div className="col-md-12">
                        <h2>¿Esta seguro que quiere eliminar el semaforo "{this.state.nombre}" ?</h2>
                    </div>
                </div>
            ];
            acciones = [
                ...
                <section className="has-actions">
                    <div className="section-body">
                        <div className = "section-header">
                            <h2 className = "text-primary">Semaforos</h2>
                        </div>
                        <BootstrapTable data={this.state.semaforos}
                                        pagination={true}
                                        options={{ noDataText :"No hay semaforos para esta cuenta"}}
                                        hover={true}
                                        search={true}>
