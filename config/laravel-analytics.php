...
return
    ...
    [
         ...
         */
        'clientId' => '227707888393-7lhu4b2t7r0s030qv3k25317eiih30d7.apps.googleusercontent.com',
         ...
         */
        'serviceEmail' => 'dood-analytics@dood-1359.iam.gserviceaccount.com',

        /*
         * You need to download a p12-certifciate from the Google API console
         * Be sure to store this file in a secure location.
         */
        'certificatePath' => storage_path('app/laravel-analytics/Dood-bf8dab75a598.p12'),
